...
Zero-runtime CSS-in-TS. Styles live in `.css.ts` files colocated with their component. Vanilla-Extract-specific concerns only (`style` arrays, variants vs. recipes, themes, sprinkles); general CSS rules live in [css.md](./css.md) and apply here too.

Rationale: [vanilla-extract-css.why.md](./vanilla-extract-css.why.md). Strength levels: [\_index.md](./_index.md).
